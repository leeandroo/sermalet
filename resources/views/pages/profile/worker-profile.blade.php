...
@section('titulo', 'Perfil de trabajador')
@section('contenido')
<div class="row">
        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="container-fluid">
                    <h1 class="sub-title mb-3">Servicios asignados</h1>
                    @if($citas->count() > 0)
                                ...
                                @foreach($citas as $cita)
                                    <tr>
                                        ...
                                        <td class="align-baseline">
                                            <a href="{{ url("/details/{$cita->idorden_trabajo}") }}" class="btn btn-sm cyan white-text">Detalle</a>
                                        </td>
                                    </tr>
                                @endforeach
